...
//     "onlineRate": 45000.0,
//     "sellingPrice": 50000.0, // Used as the striking / original market value reference
//     "percentOff": 10.0,
//     "largeImage": "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800", // Placeholder matching cloud format
...
//   // State management matching backend payload variants
//   const [selectedVariant, setSelectedVariant] = useState(productData.variants[0]);
//   const [quantity, setQuantity] = useState(1);

//   // Split string features array mapping safely
...
//             {/* Dynamic Price tied directly to chosen variant / online rate mapping */}
...
//                   <Ionicons name="checkmark-circle-outline" size={13} color="black" className="mr-1" />
...
//           }`}
//         >
//           <Feather name="shopping-cart" size={16} color="white" className="mr-2" />
//           <Text className="text-white font-black text-xs tracking-wider ml-2">
//             {selectedVariant.stockLevel === 0 ? 'OUT OF STOCK' : 'ADD TO BAG'}
//           </Text>
//         </TouchableOpacity>
//       </View>
//     </SafeAreaView>
